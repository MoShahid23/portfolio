...
function Footer() {
    return (
      <footer className="flex-col flex gap-4 items-center justify-end h-32 p-4 bg-accent bg-[url('./src/assets/stripe-texture.png')] bg-repeat bg-[length:50px] text-white text-sm">
