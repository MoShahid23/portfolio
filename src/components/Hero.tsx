function Home() {
    return (
        ...
        >
            <div className="animate-fade-in-slow absolute inset-0 bg-[url('./src/assets/old-wall.png')] bg-repeat bg-[length:300px] pointer-events-none z-0" />
            ...
            <div className="relative z-10 fade flex flex-col items-start w-max mx-auto animate-slide">
              ...
              <div className="text-4xl font-light w-1/2 place-self-center">
                  a full-stack developer who enjoys turning ideas into
