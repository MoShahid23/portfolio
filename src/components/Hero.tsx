function Home() {
    return (
        ...
        >
            ...
            <div className="relative z-10 fade flex flex-col items-start w-1/1 mx-auto animate-slide">
              <div className="text-5xl font-bold leading-relaxed place-self-center">
                  Hi, I'm Mo.
              </div>
              <div className="text-4xl font-light place-self-center">
