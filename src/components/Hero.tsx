function Home() {
    return (
        ...
        >
            ...
            <div className="relative z-10 fade flex flex-col items-start w-fit mx-auto animate-slide">
              <div className="text-5xl font-bold leading-relaxed place-self-start">
                  Hi, I'm Mo.
              </div>
